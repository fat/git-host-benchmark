...
import { WorktreeManager, gitAdd, gitCommit, gitPush, } from "../../utils/git.js";
...
export class WorktreeCommitBenchmark extends BaseBenchmark {
    ...
    constructor(config, baseRepoPath, namePrefix) {
        super(namePrefix
            ? `${namePrefix} / Concurrent Worktree Commit & Push`
            : "Concurrent Worktree Commit & Push", config);
...
//# sourceMappingURL=worktreeCommit.js.map